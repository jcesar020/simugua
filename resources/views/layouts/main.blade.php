...
<head>
    ...
    <title>SimuAagua | Pagina vacia</title>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"><strong>Julio Arce</strong><span class="text-muted text-xs block">Administrador<b class="caret"></b></span> </span> </a>
                ...
                <li>
                    <a href="index-2.html"><i class="fa fa-th-large"></i> <span class="nav-label">Escritorio</span> </a>
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="500.html">Materiales</a></li>
                        <li ><a href="vacia.html">Empty page</a></li>
                    </ul>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg">
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <strong>Mike Loreipsum</strong> comenzo a seguirte <strong>Monica Smith</strong>. <br>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    ...
                                    <div class="media-body ">
                                        ...
                                        <strong>Monica Smith</strong> Hola <strong>Kim Smith</strong>. <br>
                                        <small class="text-muted">hace 2 dias a  2:30 am - 11.06.2014</small>
                                    </div>
                                </div>
                            </li>
                            <li class="divider"></li>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-4">
                ...
                <ol class="breadcrumb">
                    <li>Esto es</li>
                    <li class="active">
                        <strong>Migas de pan</strong>
                    </li>
                </ol>
            </div>
            <div class="col-sm-8">
                <div class="title-action">
                    <a href="#" class="btn btn-primary">Esta es el area de accion</a>
                </div>
            </div>
        </div>
        ...
        <div class="footer">
            <div class="pull-right">
                10GB of <strong>250GB</strong> Gratis.
            </div>
            <div>
                <strong>Derechos Reservados</strong> ArceSoft,S.A. de C.V. &copy; 2016-2017
            </div>
        </div>
