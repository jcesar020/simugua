...
class LecturaconController extends Controller
{
    /**
    ...
    public function listar($id){
        //Listar las lecturas de la conexion
        $con= Conexion::conexion($id);
        $lecturas =Lectura::listar($id);
       //return Lectura::listar($id);
        return view('lecturacon.index')
